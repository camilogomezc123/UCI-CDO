@extends('layouts.app')
@section('title', 'Trazador Post-paro · ' . $paciente->nombre)

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h4 class="mb-0"><i class="bi bi-heart-pulse me-2 text-danger"></i>Trazador Post-paro cardíaco</h4>
    ...
    <form action="{{ route('trazadores.store', $trazador) }}" method="POST">
        ...
        <div class="card border-0 shadow-sm mb-3">
            <div class="card-header bg-white fw-semibold py-2">
                <i class="bi bi-clipboard me-2 text-danger"></i>{{ $seccion['titulo'] }}
            </div>
            <div class="card-body">
                <div class="row g-3">
        ...
        <div class="d-flex justify-content-end gap-2 mb-4">
            ...
            <button type="submit" class="btn btn-danger px-4">
                <i class="bi bi-save me-1"></i>Guardar trazador Post-paro
            </button>
        </div>
    </form>
</div>
